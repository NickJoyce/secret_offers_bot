...
class BlackListMiddleware(BaseMiddleware):
        async def __call__(self,
            ...
            ids = [user.tg_id for user in black_list if user.tg_id and user.is_active is True]
            usernames = [user.tg_username for user in black_list if user.tg_username and user.is_active is True]
