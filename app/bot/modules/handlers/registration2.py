...
👉 Чтобы продолжить и получить доступ к каналу, нужно зарегистрироваться. Отправляя форму ты даешь согласие на обработку <a href="URL">текст ссылки</a>. 

Напиши, как тебя зовут:"""
        await msg.answer(text=escape_markdown_v2(text), parse_mode=ParseMode.HTML)
