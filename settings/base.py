...
SQLALCHEMY_DRIVER_SYNC = 'psycopg2'

# асинхронный url
SQLALCHEMY_URL_ASYNC = f"{SQLALCHEMY_DIALECT}+{SQLALCHEMY_DRIVER}://{USERNAME}:{PASSWORD}@{HOST}:{PORT}/{DATABASE}"
# синхронный url
SQLALCHEMY_URL_SYNC = f"{SQLALCHEMY_DIALECT}+{SQLALCHEMY_DRIVER_SYNC}://{USERNAME}:{PASSWORD}@{HOST}:{PORT}/{DATABASE}"
